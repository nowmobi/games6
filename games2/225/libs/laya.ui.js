!function(t, i, e) {
    e.un, e.uns;
    var s = e.static, h = e.class, n = e.getset, o = (e.__newvec, laya.display.Animation), r = laya.utils.Browser, l = laya.utils.ClassUtils, a = laya.filters.ColorFilter, c = laya.components.Component, u = (laya.Const, 
    laya.utils.Ease), _ = laya.events.Event, d = laya.display.Graphics, f = laya.utils.Handler, g = laya.display.Input, p = laya.net.Loader, m = laya.net.LocalStorage, v = laya.maths.Matrix, y = (laya.display.Node, 
    laya.maths.Point), C = laya.maths.Rectangle, b = (laya.renders.Render, laya.display.Scene), S = laya.utils.SceneUtils, w = laya.display.Sprite, x = (laya.display.Stage, 
    laya.display.Text), B = laya.resource.Texture, k = laya.utils.Tween, I = laya.utils.Utils, L = laya.utils.WeakObject;
    e.interface("laya.ui.IBox"), e.interface("laya.ui.IItem"), e.interface("laya.ui.IRender"), 
    e.interface("laya.ui.ISelect");
    var M = function() {
        function t() {}
        return h(t, "laya.ui.UIUtils"), t.fillArray = function(t, i, e) {
            var s = t.concat();
            if (i) for (var h = i.split(","), n = 0, o = Math.min(s.length, h.length); n < o; n++) {
                var r = h[n];
            ...
            if (null == s) {
                var h = '"' + i + '"', n = "(function(data){if(data==null)return;with(data){try{\nreturn " + (h = h.replace(/^"\${|}"$/g, "").replace(/\${/g, '"+').replace(/}/g, '+"')) + "\n}catch(e){}}})";
            ...
            return this._funMap = new L();
        } ]), t;
    }(), z = function() {
        function t() {}
        return h(t, "laya.ui.Styles"), t.labelColor = "#000000", t.buttonStateNum = 3, t.scrollBarMinNum = 15, 
        ...
        function t() {}
        return h(t, "UIConfig"), t.touchScrollEnable = !0, t.mouseWheelEnable = !0, t.showButtons = !0, 
        ...
        return s.destroy = function() {
            ...
            if (t && t.bitmap) {
                ...
                if (!h || n === e && o === s) this.clear(), this.drawTexture(t, this._offset ? this._offset[0] : 0, this._offset ? this._offset[1] : 0, e, s); else {
                    this.clear();
                    var r = h[0], l = h[1], a = h[2], c = h[3], u = h[4], _ = !1;
                    if (e == n && (c = l = 0), s == o && (r = a = 0), c + l > e) {
                        var d = e;
                        _ = !0, e = c + l, this.save(), this.clipRect(0, 0, d, s);
                    }
                    c && r && this.drawImage(i.getTexture(t, 0, 0, c, r), 0, 0, c, r), l && r && this.drawImage(i.getTexture(t, n - l, 0, l, r), e - l, 0, l, r), 
                    c && a && this.drawImage(i.getTexture(t, 0, o - a, c, a), 0, s - a, c, a), l && a && this.drawImage(i.getTexture(t, n - l, o - a, l, a), e - l, s - a, l, a), 
                    r && this.drawBitmap(u, i.getTexture(t, c, 0, n - c - l, r), c, 0, e - c - l, r), 
                    a && this.drawBitmap(u, i.getTexture(t, c, o - a, n - c - l, a), c, s - a, e - c - l, a), 
                    c && this.drawBitmap(u, i.getTexture(t, 0, r, c, o - r - a), 0, r, c, s - r - a), 
                    l && this.drawBitmap(u, i.getTexture(t, n - l, r, l, o - r - a), e - l, r, l, s - r - a), 
                    this.drawBitmap(u, i.getTexture(t, c, r, n - c - l, o - r - a), c, r, e - c - l, s - r - a), 
                    _ && this.restore();
                }
                this._repaint();
            }
        }, s.drawBitmap = function(t, i, e, s, h, n) {
            void 0 === h && (h = 0), void 0 === n && (n = 0), h < .1 || n < .1 || (!t || i.width == h && i.height == n ? this.drawImage(i, e, s, h, n) : this.fillTexture(i, e, s, h, n));
            ...
            s <= 0 && (s = 1), h <= 0 && (h = 1), t.$_GID || (t.$_GID = I.getGID());
            var n;
            return n && n._getSource() || (n = B.createFromTexture(t, i, e, s, h)), n;
        }, i;
    }(d), Y = (function(t) {
        function i() {
            i.__super.call(this);
        }
        h(i, "laya.ui.UIEvent", _), i.SHOW_TIP = "showtip", i.HIDE_TIP = "hidetip";
    }(), function(t) {
        function i() {
            i.__super.call(this), this._top = NaN, this._bottom = NaN, this._left = NaN, this._right = NaN, 
            this._centerX = NaN, this._centerY = NaN;
        }
        h(i, "laya.ui.Widget", c);
        var e = i.prototype;
        ...
        function i() {
            ...
            this._widget = Y.EMPTY, this.preinitialize(), this.createChildren(), this.initialize();
        }
        h(i, "laya.ui.UIComponent", t);
        var s = i.prototype;
        ...
        s.measureWidth = function() {
            ...
            this.event("resize"), this._widget !== Y.EMPTY && this._widget.resetLayout();
            ...
            return this._widget === Y.EMPTY && (this._widget = this.addComponent(Y)), this._widget;
            ...
            e.superGet(w, this, "width") != t && (e.superSet(w, this, "width", t), this.callLater(this._sizeChanged));
            ...
            e.superGet(w, this, "height") != t && (e.superSet(w, this, "height", t), this.callLater(this._sizeChanged));
        }), n(0, s, "left", function() {
            ...
            e.superGet(w, this, "scaleX") != t && (e.superSet(w, this, "scaleX", t), this.event("resize"));
        }), n(0, s, "scaleY", t.prototype._$get_scaleY, function(t) {
            e.superGet(w, this, "scaleY") != t && (e.superSet(w, this, "scaleY", t), this.event("resize"));
        ...
        function i() {
            this.lockLayer = null, this.popupEffect = function(t) {
                t.scale(1, 1), t._effectTween = k.from(t, {
                    x: e.stage.width / 2,
                    y: e.stage.height / 2,
                    scaleX: 0,
                    scaleY: 0
                ...
                t._effectTween = k.to(t, {
                    x: e.stage.width / 2,
                    y: e.stage.height / 2,
                    scaleX: 0,
                    scaleY: 0
                }, 300, u.strongOut, f.create(this, this.doClose, [ t ]), 0, !1, !1);
            }, i.__super.call(this), this.maskLayer = new w(), this.popupEffectHandler = new f(this, this.popupEffect), 
        ...
        return s._closeOnSide = function() {
            ...
            t._effectTween && (k.clear(t._effectTween), t._effectTween = null);
        }, s.doOpen = function(t) {
            t.onOpened(t._param);
        }, s.lock = function(t) {
        ...
        function i() {
            ...
            this._anchorY = NaN, this._widget = Y.EMPTY, i.__super.call(this);
        }
        h(i, "laya.ui.View", t);
        var s = i.prototype;
        return s.destroy = function(i) {
            ...
            l.regShortClassName([ tt, V, _t, G, X, nt, V, rt, U, $, O, q, ht, E, R, st, Q, W, ot, ct, N, D, at, Z, i, F, j, it, et, ut, dt, w, o, x, lt ]);
        }, i;
    }(b), N = function(t) {
        function i(t) {
        ...
        return s.destroy = function(i) {
            ...
            this.addChild(this.slider = new D()), this.addChild(this.upButton = new V()), this.addChild(this.downButton = new V());
            ...
            this.slide(i), e.timer.once(z.scrollBarDelayTime, this, this.startLoop, [ i ]), 
            ...
            this._lastOffset = 0, this._checkElastic = !1, this._lastPoint || (this._lastPoint = new y()), 
            this._lastPoint.setTo(e.stage.mouseX, e.stage.mouseY), e.timer.clear(this, this.tweenMove), 
            k.clearTween(this), e.stage.once("mouseup", this, this.onStageMouseUp2), e.stage.once("mouseout", this, this.onStageMouseUp2), 
            e.timer.frameLoop(1, this, this.loop));
        }, s.startDragForce = function() {
            this._clickOnly = !0, this._lastOffset = 0, this._checkElastic = !1, this._lastPoint || (this._lastPoint = new y()), 
            this._lastPoint.setTo(e.stage.mouseX, e.stage.mouseY), e.timer.clear(this, this.tweenMove), 
            k.clearTween(this), e.stage.once("mouseup", this, this.onStageMouseUp2), e.stage.once("mouseout", this, this.onStageMouseUp2), 
            e.timer.frameLoop(1, this, this.loop);
            ...
            this._isElastic) this._value < this.min ? k.to(this, {
                value: this.min
            }, this.elasticBackTime, u.sineOut, f.create(this, this.elasticOver)) : this._value > this.max && k.to(this, {
                value: this.max
            ...
            this._isElastic = !1, !this.hide && this.autoHide && k.to(this, {
                alpha: 0
            }, 500), this.event("end");
            ...
            if (this._lastOffset *= this.rollRatio, !this.checkTriggers(!0)) {
                ...
                this.value -= this._lastOffset, Math.abs(this._lastOffset) < .1) {
                    if (e.timer.clear(this, this.tweenMove), this._isElastic) return void (this._value < this.min ? k.to(this, {
                        value: this.min
                    }, this.elasticBackTime, u.sineOut, f.create(this, this.elasticOver)) : this._value > this.max ? k.to(this, {
                        value: this.max
                    }, this.elasticBackTime, u.sineOut, f.create(this, this.elasticOver)) : this.elasticOver());
                    this.event("end"), !this.hide && this.autoHide && k.to(this, {
                        alpha: 0
                    }, 500);
                }
            }
        }, s.stopScroll = function() {
            this.onStageMouseUp2(null), e.timer.clear(this, this.tweenMove), k.clearTween(this);
        }, n(0, s, "thumbPercent", function() {
            return this._thumbPercent;
        }, function(t) {
            this.runCallLater(this.changeScrollBar), this.runCallLater(this._sizeChanged), t = t >= 1 ? .99 : t, 
            this._thumbPercent = t, this.scaleBar && (this.slider.isVertical ? this.slider.bar.height = Math.max(this.slider.height * t, z.scrollBarMinNum) : this.slider.bar.width = Math.max(this.slider.width * t, z.scrollBarMinNum));
        }), n(0, s, "dataSource", t.prototype._$get_dataSource, function(t) {
            this._dataSource = t, "number" == typeof t || "string" == typeof t ? this.value = Number(t) : e.superSet(O, this, "dataSource", t);
        }), n(0, s, "skin", function() {
            return this._skin;
        }, function(t) {
            " " != t && this._skin != t && (this._skin = t, this._skin && !p.getRes(this._skin) ? e.loader.load([ this._skin, this._skin.replace(".png", "$up.png"), this._skin.replace(".png", "$down.png"), this._skin.replace(".png", "$bar.png") ], f.create(this, this._skinLoaded)) : this._skinLoaded());
        }), n(0, s, "max", function() {
        ...
        return s.destroy = function(i) {
            ...
            this._dataSource = t, "string" == typeof t ? this.skin = t : e.superSet(O, this, "dataSource", t);
        }), n(0, s, "source", function() {
            ...
            this._bitmap.sizeGrid = M.fillArray(z.defaultSizeGrid, t, Number);
        }), n(0, s, "group", function() {
            return this._group;
        }, function(t) {
            t && this._skin && p.setGroup(this._skin, t), this._group = t;
        }), n(0, s, "width", t.prototype._$get_width, function(t) {
            e.superSet(O, this, "width", t), this._bitmap.width = 0 == t ? 1e-7 : t;
        }), n(0, s, "height", t.prototype._$get_height, function(t) {
            e.superSet(O, this, "height", t), this._bitmap.height = 0 == t ? 1e-7 : t;
        }), i;
    }(O), D = function(t) {
        function i(t) {
        ...
        return o.destroy = function(i) {
            ...
            this.addChild(this._bg = new E()), this.addChild(this._bar = new V());
            ...
            this._globalSacle || (this._globalSacle = new y()), this._globalSacle.setTo(this.globalScaleX || .01, this.globalScaleY || .01), 
            ...
            p.getRes(t) && (this._progress || (this.addChild(this._progress = new E()), this._progress.sizeGrid = this._bar.sizeGrid, 
            ...
            this._skin != t && (this._skin = t, this._skin && !p.getRes(this._skin) ? e.loader.load([ this._skin, this._skin.replace(".png", "$bar.png") ], f.create(this, this._skinLoaded)) : this._skinLoaded());
        }), n(0, o, "tick", function() {
            return this._tick;
        }, function(t) {
        ...
        return s.destroy = function(i) {
            ...
            this._tf.padding = M.fillArray(z.labelPadding, t, Number);
        }), n(0, s, "bold", function() {
            ...
            this._dataSource = t, "number" == typeof t || "string" == typeof t ? this.text = t + "" : e.superSet(O, this, "dataSource", t);
            ...
            return this._width || this._tf.text ? e.superGet(O, this, "width") : 0;
        }, function(t) {
            e.superSet(O, this, "width", t), this._tf.width = t;
        }), n(0, s, "height", function() {
            return this._height || this._tf.text ? e.superGet(O, this, "height") : 0;
        }, function(t) {
            e.superSet(O, this, "height", t), this._tf.height = t;
        ...
        return s.destroy = function(i) {
            ...
            this.addChild(this._colorButton = new V()), this._colorPanel = new X(), this._colorPanel.size(230, 166), 
            ...
            var t = this.localToGlobal(new y()), i = t.x + this._colorPanel.width <= e.stage.width ? t.x : e.stage.width - this._colorPanel.width, s = t.y + this._colorButton.height;
        ...
        function i(t, e) {
            ...
            this._clickHandler = null, this._stateChanged = !1, i.__super.call(this), this._labelColors = z.buttonLabelColors, 
            this._stateNum = z.buttonStateNum, void 0 === e && (e = ""), this.skin = t, this.label = e;
        }
        ...
        return e.imps(o, {
            ...
            this._text || (this._text = new x(), this._text.overflow = "hidden", this._text.align = "center", 
            ...
            var t = p.getRes(this._skin);
            if (t) {
                var i = t.sourceWidth, e = t.sourceHeight / this._stateNum;
                t.$_GID || (t.$_GID = I.getGID());
                var s = t.$_GID + "-" + this._stateNum, h = L.I.get(s);
                if (I.isOkTextureList(h) || (h = null), h) this._sources = h; else {
                    if (this._sources = [], 1 === this._stateNum) this._sources.push(t); else for (var n = 0; n < this._stateNum; n++) this._sources.push(B.createFromTexture(t, 0, e * n, i, e));
                    L.I.set(s, this._sources);
                }
            ...
            this._skin != t && (this._skin = t, t ? p.getRes(t) ? this._skinLoaded() : e.loader.load(this._skin, f.create(this, this._skinLoaded), null, "image", 1) : this._skinLoaded());
        }), n(0, o, "labelPadding", function() {
            return this.createText(), this._text.padding.join(",");
        }, function(t) {
            this.createText(), this._text.padding = M.fillArray(z.labelPadding, t, Number);
            ...
            this._strokeColors = M.fillArray(z.buttonLabelColors, t, String), this._setStateChanged();
        }), n(0, o, "labelColors", function() {
            return this._labelColors.join(",");
        }, function(t) {
            this._labelColors = M.fillArray(z.buttonLabelColors, t, String), this._setStateChanged();
            ...
            e.superSet(O, this, "width", t), this._autoSize && (this._bitmap.width = t, this._text && (this._text.width = t));
        }), n(0, o, "height", t.prototype._$get_height, function(t) {
            e.superSet(O, this, "height", t), this._autoSize && (this._bitmap.height = t, this._text && (this._text.height = t));
        }), n(0, o, "dataSource", t.prototype._$get_dataSource, function(t) {
            this._dataSource = t, "number" == typeof t || "string" == typeof t ? this.label = t + "" : e.superSet(O, this, "dataSource", t);
        ...
        return s.destroy = function(i) {
            ...
            this._skin != t && (this._skin = t, this._skin && !p.getRes(this._skin) ? e.loader.load(this._skin, f.create(this, this._skinLoaded), null, "image", 1) : this._skinLoaded());
        }), n(0, s, "height", t.prototype._$get_height, function(t) {
            e.superSet(O, this, "height", t), this._bg.height = this._height, this._bar.height = this._height;
        }), n(0, s, "bar", function() {
            return this._bar;
        }), n(0, s, "value", function() {
            return this._value;
            ...
            e.superSet(O, this, "width", t), this._bg.width = this._width, this.callLater(this.changeValue);
        }), i;
    }(O), $ = (function(t) {
        function i() {
            this._tipBox = null, this._tipText = null, this._defaultTipHandler = null, i.__super.call(this), 
            this._tipBox = new O(), this._tipBox.addChild(this._tipText = new x()), this._tipText.x = this._tipText.y = 5, 
        ...
        s._onStageHideTip = function(t) {
            ...
            var h = t.getBounds();
            t.x = e.stage.mouseX + i, t.y = e.stage.mouseY + s, t._x + h.width > e.stage.width && (t.x -= h.width + i), 
            t._y + h.height > e.stage.height && (t.y -= h.height + s);
        }, s.closeAll = function() {
        ...
        function i(t, e) {
            ...
            this._itemColors = z.comboBoxItemColors, this.skin = t, this.labels = e;
        }
        ...
        return s.destroy = function(i) {
            ...
            e.superSet(O, this, "width", t), this._button.width = this._width, this._itemChanged = !0, 
            this._listChanged = !0;
            ...
            e.superSet(O, this, "height", t), this._button.height = this._height;
            ...
            this._isOpen) {
                ...
                var i = this.localToGlobal(y.TEMP.setTo(0, 0)), s = i.y + this._button.height;
            ...
            this._dataSource = t, "number" == typeof t && Math.floor(t) == t || "string" == typeof t ? this.selectedIndex = parseInt(t) : t instanceof Array ? this.labels = t.join(",") : e.superSet(O, this, "dataSource", t);
            ...
            this._button.text.padding = M.fillArray(z.labelPadding, t, Number);
        ...
        h(s, "laya.ui.WXOpenDataViewer", i);
        var o = s.prototype;
        o.onEnable = function() {
            this.postMsg({
                type: "display",
            ...
            if (t.wx && t.wx.getOpenDataContext) {
                t.wx.getOpenDataContext().postMessage(i);
            }
        }, n(0, o, "x", i.prototype._$get_x, function(t) {
            e.superSet(O, this, "x", t), this.callLater(this._postMsg);
        }), n(0, o, "width", i.prototype._$get_width, function(i) {
            e.superSet(O, this, "width", i), t.sharedCanvas && (t.sharedCanvas.width = i), this.callLater(this._postMsg);
        }), n(0, o, "height", i.prototype._$get_height, function(i) {
            e.superSet(O, this, "height", i), t.sharedCanvas && (t.sharedCanvas.height = i), 
            this.callLater(this._postMsg);
        }), n(0, o, "y", i.prototype._$get_y, function(t) {
            e.superSet(O, this, "y", t), this.callLater(this._postMsg);
        });
    }(O), function(t) {
        function i(t, e, s) {
        ...
        return s.destroy = function(i) {
            ...
            if (t === this._skin && i) {
                var e = this._clipWidth || Math.ceil(i.sourceWidth / this._clipX), s = this._clipHeight || Math.ceil(i.sourceHeight / this._clipY), h = this._skin + e + s, n = L.I.get(h);
                if (I.isOkTextureList(n) || (n = null), n) this._sources = n; else {
                    this._sources = [];
                    for (var o = 0; o < this._clipY; o++) for (var r = 0; r < this._clipX; r++) this._sources.push(B.createFromTexture(i, e * r, s * o, e, s));
                    L.I.set(h, this._sources);
                }
            ...
            this._skin != t && (this._skin = t, t ? p.getRes(t) ? this._skinLoaded() : e.loader.load(this._skin, f.create(this, this._skinLoaded), null, "image", 1) : this._bitmap.source = null);
            ...
            e.superSet(O, this, "width", t), this._bitmap.width = t;
        }), n(0, s, "height", t.prototype._$get_height, function(t) {
            e.superSet(O, this, "height", t), this._bitmap.height = t;
            ...
            this._dataSource = t, "number" == typeof t && Math.floor(t) == t || "string" == typeof t ? this.index = parseInt(t) : e.superSet(O, this, "dataSource", t);
        ...
        return s._dealDragArea = function() {
            ...
            if (t) {
                var i = M.fillArray([ 0, 0, 0, 0 ], t, Number);
                this._dragArea = new C(i[0], i[1], i[2], i[3]), this.on("mousedown", this, this._onMouseDown);
            ...
            e.superSet(A, this, "zOrder", t), i.manager._checkMask();
        ...
        return h(i, "laya.ui.VScrollBar", N), i;
    }(), q = function(t) {
        function i() {
            i.__super.call(this);
        }
        ...
        h(i, "laya.ui.AdvImage", t);
        var s = i.prototype;
        s.setLoadUrl = function() {
            ...
            var t = this, i = this.advsListArr[this._playIndex], e = parseInt(i.gameid), s = i.extendInfo, h = i.path;
            if (r.onLimixiu) {
                if (!i.isLunBo && !i.isLunBo) {
                    var n = m.getJSON("gameObj");
                    n || (n = {}), n[i.gameid] || (n[i.gameid] = {}), n[i.gameid] = {
                        isclick: !0
                    }, m.setJSON("gameObj", n), this.advsListArr.splice(this._playIndex, 1);
                }
        ...
        return s.destroy = function(t) {
            ...
            var e = this._content;
            e.width = t, e.height = i, e._style.scrollRect || (e.scrollRect = C.create()), e._style.scrollRect.setTo(0, 0, t, i), 
            ...
            null == this._hScrollBar && (laya.display.Node.prototype.addChild.call(this, this._hScrollBar = new q()), 
            ...
            null == this._vScrollBar && (laya.display.Node.prototype.addChild.call(this, this._vScrollBar = new j()), 
        ...
        return s.preinitialize = function() {
            ...
            this.addChild(this._tf = new g()), this._tf.padding = z.inputLabelPadding, this._tf.on("input", this, this._onInput), 
            ...
            this._bg || (this.graphics = this._bg = new P()), this._bg.source = p.getRes(this._skin), 
            ...
            this._bg || (this.graphics = this._bg = new P()), this._bg.sizeGrid = M.fillArray(z.defaultSizeGrid, t, Number);
        }), n(0, s, "width", t.prototype._$get_width, function(t) {
        ...
        return h(i, "laya.ui.VSlider", D), i;
    }(), et = function(t) {
        function i() {
        ...
        return e.imps(s, {
            ...
            if (!s) {
                ...
                for (var a in l) {
                    var c = (r = l[a]).nodeName, u = r.nodeValue;
            ...
            for (var e = 0, s = i.length; e < s; e++) {
                var h = i[e];
                if (h.isDirectory) for (var n = 0, o = t.length; n < o; n++) {
                    var r = t[n];
            ...
            var s;
            for (var h in t) !(s = t[h]).isDirectory && String(s.label).toLowerCase().indexOf(e) > -1 && (s.x = 0, 
        ...
        function i() {
            ...
            this._preLen = 0, i.__super.call(this), this._cells = [], this._offset = new y();
        }
        h(i, "laya.ui.List", t);
        var s = i.prototype;
        return e.imps(s, {
            ...
            for (var u = t; u < e; u++) for (var _ = 0; _ < i; _++) (h = l && l.length ? l.pop() : this.createItem()).x = (this._isVertical ? _ : u) * n - s._x, 
            h.y = (this._isVertical ? u : _) * o - s._y, h.name = "item" + (u * i + _), s.addChild(h), 
            this.addCell(h);
        }, s.createItem = function() {
            var t = [];
            if ("function" == typeof this._itemRender) var i = new this._itemRender(); else i = S.createComp(this._itemRender, null, null, t);
            ...
            this._content.width = t, this._content.height = i, (this._scrollBar || 0 != this._offset.x || 0 != this._offset.y) && (this._content._style.scrollRect || (this._content.scrollRect = C.create()), 
            ...
            this.renderItems(this._createdLine * e, 0), this._createdLine += o); else {
                ...
                if (n > this._startIndex) {
                    ...
                    var r = !0, l = this._startIndex + e * (s + 1);
                    this._isMoved = !0;
                } else n < this._startIndex && (o = this._startIndex - n, r = !1, l = this._startIndex - 1, 
                this._isMoved = !0);
                for (var a = 0; a < o; a++) {
                    if (r) {
            ...
            for (var e = t._$bindData, s = 0, h = e.length; s < h; s++) {
                var n = e[s++], o = e[s++], r = e[s], l = M.getBindFun(r);
                n[o] = l.call(this, i);
            }
        ...
        return h(i, "laya.ui.HSlider", D), i;
    }(), nt = function(t) {
        function i() {
            this._oldW = 0, this._oldH = 0, i.__super.call(this);
        }
        h(i, "laya.ui.ScaleBox", t);
        var s = i.prototype;
        ...
        return s.preinitialize = function() {
            ...
            this._dataSource = t, "boolean" == typeof t ? this.selected = t : "string" == typeof t ? this.selected = "true" === t : e.superSet(V, this, "dataSource", t);
        }), i;
    }(V), lt = function(t) {
        function i(t, e) {
        ...
        return s.createChildren = function() {
            ...
            for (var e = 0; e < this._clipY; e++) for (var s = i[e].split(""), h = 0, n = s.length; h < n; h++) this._indexMap[s[h]] = e * this._clipX + h;
        }), n(0, s, "height", t.prototype._$get_height, function(t) {
            e.superSet(U, this, "height", t), this.callLater(this.changeValue);
        }), n(0, s, "direction", function() {
            return this._direction;
        }, function(t) {
            ...
            e.superSet(U, this, "width", t), this.callLater(this.changeValue);
        }), n(0, s, "spaceX", function() {
            return this._spaceX;
        }, function(t) {
        ...
        return s.sortItem = function(t) {
            ...
            this.sortItem(t);
            var n = 0;
            for (e = 0, s = t.length; e < s; e++) (h = t[e]).x = n, n += h.width * h.scaleX + this._space, 
        ...
        return s._onTextChange = function() {
            ...
            var t = this._vScrollBar && this._tf.maxScrollY > 0, i = this._hScrollBar && this._tf.maxScrollX > 0, e = t ? this._width - this._vScrollBar.width : this._width, s = i ? this._height - this._hScrollBar.height : this._height, h = this._tf.padding || z.labelPadding;
            ...
            e.superSet(Z, this, "width", t), this.callLater(this.changeScroll);
        }), n(0, s, "hScrollBar", function() {
            return this._hScrollBar;
        }), n(0, s, "height", t.prototype._$get_height, function(t) {
            e.superSet(Z, this, "height", t), this.callLater(this.changeScroll);
        }), n(0, s, "maxScrollX", function() {
            return this._tf.maxScrollX;
        }), n(0, s, "vScrollBarSkin", function() {
            return this._vScrollBar ? this._vScrollBar.skin : null;
        }, function(t) {
            null == this._vScrollBar && (this.addChild(this._vScrollBar = new j()), this._vScrollBar.on("change", this, this.onVBarChanged), 
            this._vScrollBar.target = this._tf, this.callLater(this.changeScroll)), this._vScrollBar.skin = t;
        }), n(0, s, "hScrollBarSkin", function() {
            return this._hScrollBar ? this._hScrollBar.skin : null;
        }, function(t) {
            null == this._hScrollBar && (this.addChild(this._hScrollBar = new q()), this._hScrollBar.on("change", this, this.onHBarChanged), 
        ...
        return s.changeItems = function() {
            ...
            this.sortItem(t);
            var n = 0;
            for (e = 0, s = t.length; e < s; e++) (h = t[e]).y = n, n += h.height * h.scaleY + this._space, 
